Namespace Hosting
    ...
    Public Structure JavaScriptContext
        ...
        Public Shared Sub StartDebugging(debugApplication As IDebugApplication64)
            If Not Environment.Is64BitProcess Then
                Throw New InvalidOperationException()
            End If
            ThrowIfError(JsStartDebugging(debugApplication))
        End Sub
        ...
        ''' </summary>
        ''' <param name="debugApplication">The debug application to use for debugging.</param>
        Public Shared Sub StartDebugging(debugApplication As IDebugApplication32)
